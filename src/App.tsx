...
import { Receipt, TrendUp, Users, Calculator } from '@phosphor-icons/react'
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <p className="text-sm font-medium">GST: 24XXXXX1234X1ZX</p>
              <p className="text-xs text-muted-foreground">BIS Reg: BIS/H/1234567</p>
            </div>
          </div>
        </div>
      </header>
